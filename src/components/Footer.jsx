...
const Footer = () => {
  return (
    <footer className="bg-[#100101] h-full py-10 flex  flex-col gap-8">
      <section className=" w-full mx-auto  px-[14px] md:px-[40px] py-[10px] lg:px-[80px] xl:px-[80px] lg:py-[16px]  text-center  justify-center pb-8  lg:flex items-center lg:justify-between">
      ...
      <section className="w-full mx-auto  px-[14px] md:px-[40px] py-[10px] lg:px-[80px] xl:px-[80px] lg:py-[16px] text-[14px]  font-[400]  text-[#FBFBFB] ">
        <div className="border-t-2  pt-8 lg:flex  text-center justify-between ">

        <p className="pb-4">TSA & Copyright 2025 . All Rights Reserved.</p>
        <p>Privacy Policy</p>
        </div>
      </section>
    </footer>
